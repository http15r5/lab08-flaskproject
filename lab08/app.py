...
# Імпортуємо існуючі blueprints (якщо їх немає — видаліть відповідні рядки)
    ...
    "specs": [
        {
            ...
            "rule_filter": lambda rule: True,   # Усі ендпоїнти
...
# Ініціалізація БД (створює таблиці, якщо їх ще немає)
init_db()

# Реєструємо blueprint'и
app.register_blueprint(api_v1, url_prefix="/api/v1")
# Реєструйте інші blueprint'и лише якщо вони існують у вашому проекті
try:
